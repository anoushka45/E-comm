            ...
            data.map((product) => (
              <div key={product._id} className="group relative">
                ...
                <div className="mt-4 justify-between">
                 <div>
                  <h3 className="text-sm text-gray-700"><Link href={`/product/${product.slug}`}>{product.name}</Link></h3>
                  <p className="text-gray-500 mt-1 text-sm">{product.categoryName}</p>
                 </div>
